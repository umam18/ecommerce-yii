...
$config = yii\helpers\ArrayHelper::merge(
                require(APPLICATION_PATH . '/protected/common/config/main.php'), require(APPLICATION_PATH . '/protected/common/config/main-local.php'), require(APPLICATION_PATH . '/protected/frontend/config/main.php'), require(APPLICATION_PATH . '/protected/frontend/config/main-local.php')
);
