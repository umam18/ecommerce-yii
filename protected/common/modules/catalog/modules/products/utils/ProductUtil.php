...
class ProductUtil
{
    ...
    {
        return [
                    'name'              => UsniAdaptor::t('application', 'Nama'),
                    'alias'             => UsniAdaptor::t('application', 'Alias'),
                    'model'             => UsniAdaptor::t('products', 'Model'),
                    'price'             => UsniAdaptor::t('products', 'Harga'),
                    'quantity'          => UsniAdaptor::t('products', 'Jumlah'),
                    'description'       => UsniAdaptor::t('application', 'Deskripsi'),
                    ...
                    'categories'        => UsniAdaptor::t('productCategories', 'Kategori'),
