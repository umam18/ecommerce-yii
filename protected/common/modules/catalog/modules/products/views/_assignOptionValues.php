...
<table id="option-value-table" class="table table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <td class="text-right"><?php echo UsniAdaptor::t('products', 'Jumlah');?></td>
            <td class="text-left"><?php echo UsniAdaptor::t('products', 'Subtract Stock');?></td>
            <td class="text-right"><?php echo UsniAdaptor::t('products', 'Harga');?></td>
    ...
    <tbody>
        ...
        ?>
                <tr id="option-value-row-<?php echo $index;?>" class="option-value-row">
                    ...
                    <td class="text-right">
                        <input type="text" name="ProductOptionMapping[quantity][]" value="<?php echo $optionMapping['quantity'];?>" placeholder="<?php echo UsniAdaptor::t('products', 'Jumlah');?>" class="form-control">
                    </td>
                    <td class="text-left">
                    ...
                    <td class="text-right">
                        ...
                        ?>
                        <input type="text" name="ProductOptionMapping[price][]" value="<?php echo $optionMapping['price'];?>" placeholder="<?php echo UsniAdaptor::t('products', 'Harga');?>" class="form-control"></td>
                    <td class="text-right">
