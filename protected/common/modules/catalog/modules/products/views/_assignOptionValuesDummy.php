...
<table style="display: none;">
    <tr class="option-value-row-dummy">
        ...
        <td class="text-right">
            <input type="text" name="ProductOptionMapping[quantity][]" value="" placeholder="<?php echo UsniAdaptor::t('products', 'Jumlah');?>" class="form-control">
        </td>
        <td class="text-left">
        ...
        <td class="text-right">
            ...
            ?>
            <input type="text" name="ProductOptionMapping[price][]" value="" placeholder="<?php echo UsniAdaptor::t('products', 'Harga');?>" class="form-control"></td>
        <td class="text-right">
