        ...
        if(!empty($productDiscounts))
        {
            foreach($productDiscounts as $index => $discount)
            {
                ...
                <tr class="discount-value-row" id="discount-value-row-<?php echo $index;?>">
                    ...
                    <td class="text-right">
                        <?= $form->field($discount, "[$index]quantity")->textInput(['placeholder' => UsniAdaptor::t('products', 'Jumlah')])->label(false);?>
                    </td>
                    <td class="text-left">
                        <?= $form->field($discount, "[$index]priority")->textInput(['placeholder' => UsniAdaptor::t('products', 'Priority')])->label(false);?>
                    </td>
                    <td class="text-right">
                        <?= $form->field($discount, "[$index]price")->textInput(['placeholder' => UsniAdaptor::t('products', 'Harga')])->label(false);?>
                    </td>
                    <td class="text-left">
