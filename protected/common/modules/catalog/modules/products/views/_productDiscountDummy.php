...
<table style="display: none;">
    <tr class="discount-value-row-dummy">
        ...
        <td class="text-right">
            <input type="text" name="ProductDiscount[##rowCount##][quantity]" value="" placeholder="<?php echo UsniAdaptor::t('products', 'Jumlah');?>" class="form-control">
        </td>
        <td class="text-left">
        ...
        <td class="text-right">
            <input type="text" name="ProductDiscount[##rowCount##][price]" value="" placeholder="<?php echo UsniAdaptor::t('products', 'Harga');?>" class="form-control">
        </td>
        <td class="text-left">
