...
$addCartLabel       = UsniAdaptor::t('cart', 'Tambah ke Keranjang Belanja');
$addWishListLabel   = UsniAdaptor::t('wishlist', 'Tambahkan ke Wish List');
$addCompareLabel    = UsniAdaptor::t('products', 'Bandingkan');
?>
