                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="row text-center">
                            ...
                            if ($this->product['allowWishlist'])
                            {
                                ...
                                <button type="button" data-toggle="tooltip" class="btn btn-success product-wishlist" title="" data-productid = "<?php echo $this->product['id']; ?>" data-original-title="Add to Wish List">
                                    <?php echo UsniAdaptor::t('products', 'Tambahkan ke Wishlist'); ?>
                                </button>
                                <?php
                            }
                            ?>
                            ...
                            if ($this->product['allowCompare'])
                            {
                                ...
                                <button type="button" data-toggle="tooltip" class="btn btn-success add-product-compare" title="" data-productid = "<?php echo $this->product['id']; ?>" data-original-title="Compare this Product">
                                    <?php echo UsniAdaptor::t('products', 'Bandingkan'); ?>
                                </button>
                                <?php
                            }
                            ?>
                        ...
                        $items[] = [
                                        ...
                                        'label' => UsniAdaptor::t('application', 'Deskripsi'),
                                        'active' => 'true',
                                ...
                                || ($this->product['allowReviews'] && $this->product['allowGuestReviews'] && UsniAdaptor::app()->user->isGuest === true))
                        {
                            $items[] = [
                                            ...
                                            'label' => UsniAdaptor::t('products', 'Ulasan') . "(" . $this->product['reviewCnt'] . ")",
...
<!--                            <li>
                            ...
                            <li>-->
                            <li>
                                <?php echo UsniAdaptor::t('products', 'Ketersediaan') ?></span>:<?php echo str_repeat("&nbsp", 4) ?>
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <?php
                                echo UsniAdaptor::t('products', 'Harga') . ': ' . PriceWidget::widget(['priceExcludingTax' => $this->product['priceExcludingTax'],
                        ...
                        <div id="product">
                            ...
                            <form id="detailaddtocart">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="input-quantity"><?php echo UsniAdaptor::t('products', 'Jumlah'); ?></label>
                                    ...
                                    <button type="button" id="button-cart" class="btn btn-success add-cart-detail" data-productid = "<?php echo $this->product['id']; ?>">
                                        <?php echo UsniAdaptor::t('cart', 'Tambah ke Keranjang Belanja'); ?>
                                    </button>
