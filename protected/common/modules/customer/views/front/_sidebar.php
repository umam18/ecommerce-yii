...
<nav>
  <ul id="accountsidebarlist">
      ...
      <li><?php echo Html::a(UsniAdaptor::t('users', 'Ganti Kata Sandi'), UsniAdaptor::createUrl('/customer/site/change-password')) ?></li>    
      <li><?php echo Html::a(UsniAdaptor::t('order', 'Pesanan Saya'), UsniAdaptor::createUrl('/customer/site/order-history')) ?></li>
      <li><?php echo Html::a(UsniAdaptor::t('wishlist', 'Wishlist'), UsniAdaptor::createUrl('wishlist/default/view')) ?></li>
      <li><?php echo Html::a(UsniAdaptor::t('users', 'Profile Ukuran'), UsniAdaptor::createUrl('/customer/measurement-profile')); ?></li>
