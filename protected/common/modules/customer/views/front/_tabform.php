...
if ($formDTO->getScenario() == 'registration') {
    $caption = UsniAdaptor::t('customer', 'Buat Akun');
} else {
...
$items[] = [
    'options' => ['id' => 'tabuser'],
    'label' => UsniAdaptor::t('application', 'Umum'),
    'class' => 'active',
...
$items[] = [
    ...
    'label' => UsniAdaptor::t('users', 'Data Pribadi'),
...
?>
<?= FormButtons::widget(['submitButtonLabel' => UsniAdaptor::t('application', 'Lanjutkan'), 'showCancelButton' => false]); ?>
<?php

TabbedActiveForm::end();
