...
$title              = UsniAdaptor::t('customer', 'Akun Saya');
$this->title        = $title;
        ...
        <div class="col-sm-12">
            ...
            <div class="row">
                <?php
                    ...
                    echo Html::label(UsniAdaptor::t('users', 'Nama'), null, ['class' => 'control-label col-sm-3']); 
                ?>
                <div class="col-sm-9">
            ...
            <div class="row">
                <?php echo Html::label(UsniAdaptor::t('users', 'Alamat'), null, ['class' => 'control-label col-sm-3']); ?>
                <div class="col-sm-9">
