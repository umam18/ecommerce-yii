...
<table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    <thead>
        <tr>
            <td style="<?php echo $tdHeaderStyle;?>"><?php echo UsniAdaptor::t('application', 'Nama') ?></td>
            ...
            <td style="<?php echo $tdHeaderStyle;?>"><?php echo UsniAdaptor::t('products', 'Jumlah') ?></td>
            <td style="<?php echo $tdHeaderStyle;?>"><?php echo UsniAdaptor::t('products', 'Harga Satuan') ?></td>
            <td style="<?php echo $tdHeaderStyle;?>"><?php echo UsniAdaptor::t('tax', 'Pajak') ?></td>
            <td style="<?php echo $tdHeaderStyle;?>"><?php echo UsniAdaptor::t('products', 'Harga Total') ?></td>
        </tr>
    </thead>
    <tbody>
        <?php
...
<table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    <tbody>
        ...
        <tr>
            <td style="<?php echo $tdColumnStyle;?>"><strong><?php echo UsniAdaptor::t('tax', 'Pajak'); ?></strong></td>
