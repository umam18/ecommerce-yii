...
<table class="table table-striped table-bordered">
    <thead>
        <tr>
            ...
            <th><?php echo UsniAdaptor::t('application', 'Nama'); ?></th>
            <th><?php echo UsniAdaptor::t('products', 'Options') ?></th>
            <th><?php echo UsniAdaptor::t('products', 'Jumlah'); ?></th>
            <th><?php echo UsniAdaptor::t('products', 'Harga'); ?></th>
            <th><?php echo UsniAdaptor::t('tax', 'Pajak');    ?></th>
