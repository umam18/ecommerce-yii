...
$checkout           = Html::tag('legend', UsniAdaptor::t('cart', 'Pembayaran'));
$stock              = Html::tag('legend', UsniAdaptor::t('products', 'Stock'));
$reviews            = Html::tag('legend', UsniAdaptor::t('products', 'Ulasan'));
$wishlist           = Html::tag('legend', UsniAdaptor::t('wishlist', 'Wishlist'));
$compareProducts    = Html::tag('legend', UsniAdaptor::t('products', 'Bandingkan Produk'));
