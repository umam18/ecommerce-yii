...
<div class="dropdown pull-right"> 
    ...
    if ($itemCount == 0)
    {
        ?>
        <li>
            <p class="text-center"><?php echo UsniAdaptor::t('cart', 'Keranjang belanja Anda kosong'); ?></p>
        </li>
        <?php
    }
    else
    {
        ?>
        <li>
            <div class="header-cart-title"><?php echo UsniAdaptor::t('cart', 'Lihat Keranjang');?></div>
        </li>
        <li>
            <table class="table">
                <tbody>
        ...
        <li>
            <div>
                ...
                <p class="text-right">
                    <a href="<?php echo UsniAdaptor::createUrl('cart/default/view');?>"><?php echo UsniAdaptor::t('cart', 'Lihat Keranjang');?></a> | 
                    <a href="<?php echo UsniAdaptor::createUrl('cart/checkout/index');?>"><?php echo UsniAdaptor::t('cart', 'Pembayaran');?></a>
                </p>
            </div>
        </li>
        <?php
