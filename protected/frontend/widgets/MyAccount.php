...
class MyAccount extends \yii\bootstrap\Widget
{
    ...
    public function run()
    {
        ...
        {
            $this->accountLabel = UsniAdaptor::t('users', 'Akun Saya');
        }
    ...
    public function renderListItems()
    {
        ...
        if(!UsniAdaptor::app()->user->isGuest)
        {
            ...
            $items[] = ['label' => UsniAdaptor::t('users', 'Keluar'), 'url' => UsniAdaptor::createUrl('customer/site/logout')];
        }
        else
        {
            $items[] = ['label' => UsniAdaptor::t('users', 'Daftar'), 'url' => UsniAdaptor::createUrl('customer/site/register')];
            $items[] = ['label' => UsniAdaptor::t('users', 'Masuk'), 'url' => UsniAdaptor::createUrl('customer/site/login')];
        }
