    ...
    public function attributeLabels() {
        if ($this->checkIfExtendedConfigExists()) {
            ...
            $labels = [
                ...
                'firstname' => UsniAdaptor::t('users', 'Nama Depan'),
                'lastname' => UsniAdaptor::t('users', 'Nama Belakang'),
                'mobilephone' => UsniAdaptor::t('users', 'No. HP / WhatsApp'),
                'email' => UsniAdaptor::t('users', 'Email'),
                'fullName' => UsniAdaptor::t('users', 'Nama Lengkap'),
                'profile_image' => UsniAdaptor::t('users', 'Foto Profil')
            ];
        }
