...
trait AuthIdentityTrait
{
    ...
    public function attributeHints()
    {
        ...
        {
            return array(
                 'username'    => UsniAdaptor::t('userhint', 'Harus memuat setidaknya 3 karakter. Spasi tidak diperkenankan.'),
                 'email'       => UsniAdaptor::t('userhint', 'Email yang masih aktif.'),
                 'password'    => UsniAdaptor::t('userhint', 'Harus terdiri atas 6-20 karakter.'),
                 'newPassword' => UsniAdaptor::t('userhint', 'Harus terdiri atas 6-20 karakter.'),
                 'confirmPassword' => UsniAdaptor::t('userhint', 'Harus terdiri atas 6-20 karakter.')
            );
        }
    }
}
