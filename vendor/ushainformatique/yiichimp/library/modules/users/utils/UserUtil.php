...
class UserUtil {
    ...
    public static function getAddressLabels() {
        return [
            ...
            'city' => UsniAdaptor::t('city', 'Kabupaten / Kota'),
            ...
            'useBillingAddress' => UsniAdaptor::t('users', 'Sama seperti alamat penagihan'),
        ];
    }
    ...
    public static function getUserLabels() {
        return [
            'username' => UsniAdaptor::t('users', 'Nama Pengguna'),
            'password' => UsniAdaptor::t('users', 'Kata Sandi'),
            'confirmPassword' => UsniAdaptor::t('users', 'Ulang Kata Sandi'),
